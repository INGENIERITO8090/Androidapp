...
fun main(){
   ...
   2  Condicionales \n
   3: Ciclos")
   val eleccion: Int = readLine()!!.toInt() 
   if(eleccion==1){
...
")
 ...
 val Eleccion_p1: Int = readLine()!!.toInt()
